...
var camera: Camera3D
var brush_compositor_effect

const GROUP_NAME := "camera_brushes"
const OVERLAY_ATLAS_MANAGER_GROUP_NAME := "overlay_atlas_managers"
...
func _ready() -> void:
	...
	brush_compositor_effect = camera.compositor.compositor_effects[0]
	...
	brush_compositor_effect.set("camera_brush", self)
...
func get_atlas_textures() -> void:
	var all_managers := get_tree().get_nodes_in_group(OVERLAY_ATLAS_MANAGER_GROUP_NAME)
